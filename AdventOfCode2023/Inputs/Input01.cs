...
public class Input01 : AbstractInput<FSharpList<string>, FSharpList<string>>
{
    protected override FSharpList<string> ParseInput(string input) => ListModule.OfSeq(input.Split("\n"));
