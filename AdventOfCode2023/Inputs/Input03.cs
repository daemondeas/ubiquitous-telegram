...
public class Input03 : AbstractInput<(FSharpList<Day03.number>, FSharpList<Day03.position>), (FSharpList<Day03.number>, FSharpList<Day03.position>)>
{
    protected override (FSharpList<Day03.number>, FSharpList<Day03.position>) ParseInput(string input)
    {
        var numbers = new List<Day03.number>();
        var symbols = new List<Day03.position>();
        ...
        for (var y = 0; y < rows.Length; y++){
            ...
            for (var x = 0; x < rows[y].Length; x++){
                if (rows[y][x] >= '0' && rows[y][x] <= '9'){
                    ...
                    if(rows[y][x] != '.'){
                        symbols.Add(new Day03.position(x: x, y: y));
                    }
                }
            }
...
.664.598..";
    ...
    public override string RealInput => @".....664...998........343...............851............................2............414.....................3....................948.164....
